...
class SliceEnv(gym.Env):
    ...
    def __init__(self,braid_word=[],max_braid_index=25,max_braid_length=175,inaction_penalty=0.01,final_penalty=20,max_action_count=500,starting_knot_strand=1):
        ...
        self.done=False
        self.action_list={}
        self.max_actions=max_action_count
